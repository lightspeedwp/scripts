...
All workflows in this directory are reviewed automatically by CodeRabbit for:
- Reusability and documentation
- Error handling and status checks
- Integration with project automation scripts
- Enforcement of linting, testing, and release policies
- Merge protection and governance alignment
